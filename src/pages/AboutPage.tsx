            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                    <motion.h1
                        ...
                        className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent"
                    >
                        About Mad Mike
                    </motion.h1>
                    <motion.p
                    ...
                    >
                        Crafting sonic excellence since day one
                    </motion.p>
                </div>
            </section>
